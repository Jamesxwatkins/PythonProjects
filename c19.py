...
covid_status_columns = ["Reported Date","Total Cases","Percent positive tests in last day","Resolved"]
...
daily_cases = daily_cases[["Reported Date","Total New Cases","Percent positive tests in last day",
    "Seven Day Average","Increase in Cases","Increase in Seven Day Average","Total Active","Increase in Active Cases","Increase in Positivity"]]
...
st.caption("This application shows the current status of covid-19 cases in Ontario. Data is collected from the Ontario Government website")
...
kpicol1.metric("Total Active Cases",int(latest_data["Total Active"]),int(latest_data["Increase in Active Cases"]), delta_color="inverse") #increase is bad
kpicol2.metric("Total New Cases",int(latest_data["Total New Cases"]),int(latest_data["Increase in Cases"]),delta_color="inverse")#increase is bad
kpicol3.metric("Positivity Rate %",latest_data["Positivity Rate"],int(latest_data["Increase in Positivity"]),delta_color="inverse")#increase is bad
kpicol4.metric("Seven Day Average",int(latest_data["Seven Day Average"]),int(latest_data["Increase in Seven Day Average"]),delta_color="inverse")#increase is bad
