...
covid_status_columns = ["Reported Date","Total Cases","Percent positive tests in last day","Resolved","newly_reported_deaths"]
...
daily_cases = daily_cases[["Reported Date","Total New Cases","Increase in Cases","Percent positive tests in last day","Increase in Positivity",
    "Seven Day Average","Increase in Seven Day Average","Total Active","Increase in Active Cases","newly_reported_deaths"]]

daily_cases.rename(columns={"Percent positive tests in last day":"Positivity Rate","newly_reported_deahts":"Deaths"}, inplace= True)
